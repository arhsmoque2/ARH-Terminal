...
public final class DaggerARHTerminalApp_HiltComponents_SingletonC {
  private DaggerARHTerminalApp_HiltComponents_SingletonC() {
  }
  ...
  private static final class ActivityRetainedCBuilder implements ARHTerminalApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public ARHTerminalApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements ARHTerminalApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ARHTerminalApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements ARHTerminalApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ARHTerminalApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements ARHTerminalApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ARHTerminalApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements ARHTerminalApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ARHTerminalApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements ARHTerminalApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ARHTerminalApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements ARHTerminalApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public ARHTerminalApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends ARHTerminalApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends ARHTerminalApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends ARHTerminalApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends ARHTerminalApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(SessionViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, SessionViewModel_HiltModules.KeyModule.provide()));
    }
  ...
  private static final class ViewModelCImpl extends ARHTerminalApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.sessionViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(SessionViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (sessionViewModelProvider))));
    }
  ...
  private static final class ActivityRetainedCImpl extends ARHTerminalApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends ARHTerminalApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends ARHTerminalApp_HiltComponents.SingletonC {
    ...
    Provider<AccessibilityBridge> provideAccessibilityBridgeProvider;

    Provider<AndroidToolRegistry> provideAndroidToolRegistryProvider;
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.pocketshell.core.tmux.TmuxClientFactory
          return (T) TerminalModule_ProvideTmuxClientFactoryFactory.provideTmuxClientFactory(singletonCImpl.provideApplicationScopeProvider.get());
          ...
          case 4: // com.arh.terminal.core.mcp.server.McpServerEngine
          return (T) TerminalModule_ProvideMcpServerEngineFactory.provideMcpServerEngine(singletonCImpl.provideAndroidToolRegistryProvider.get(), singletonCImpl.provideApplicationScopeProvider.get());

          case 5: // com.arh.terminal.core.mcp.tools.AndroidToolRegistry
          return (T) TerminalModule_ProvideAndroidToolRegistryFactory.provideAndroidToolRegistry(singletonCImpl.provideAccessibilityBridgeProvider.get());
